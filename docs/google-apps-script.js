...
const ACCESS_TOKEN = 'EAAMZCXTVsfUoBQZATWdhgDMi8nwQZAcJLX1IXY6u57UYD99ZBK0qZAhr8zgZCq3urXLJ6ZC6u26ZCUY15ZCWCgcwN0TU9YrXsU3ezA2g6EmLFG4aCfH4c43AVEWDXCcw66XfZAOszVrAK4e9iifrSfa8bzLlFFqvuXW0bnbuDYtyjWqmNwzDxAspATZCARJWXg9'; 
...
function fetchMetaAdsData() {
  ...
  // Decide se fará a carga completa (7 dias) ou apenas a atualização (1 dia)
  const isUpdate = Object.keys(existingData).length > 0;
  const daysToFetch = isUpdate ? 1 : 7;
